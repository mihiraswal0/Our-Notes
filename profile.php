...
<!--Container-->
            ...
            <div class="modal-dialog">
              ...
              <div class="modal-body">
                  ...
                  <div class="form-group">
                      ...
                      <input class="form-control" type="email" name="email" id="email" maxlength="50" value="<?php echo $_SESSION['email']; ?>">
                  </div>
    ...
    <!-- Footer-->
      <div class="footer">
          <div class="container">
              <p>Mihir Aswal Copyright &copy; 2022-<?php $today = date("Y"); echo $today?>.</p>
          </div>
      </div>
